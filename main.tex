...
\begin{abstract}
  ...
  In the section \ref{sec_Intro} we describe the problem and structure of the matrices $M$ and $B$. In section \ref{sec:Lapack} we will discuss the how the Lapack was being used to solve the generalized eigenvalue problem and the issue associated with it. In section \ref{sec:Arpack} we will describe how using Arpack to solve the generalized eigenvalue problem makes the algorithm scale better. In section \ref{sec:Timing data} we present some timing data.

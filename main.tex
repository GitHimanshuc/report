...
ARPACK converges much faster when we solve for the largest eigenvalues, and they are well separated. This can be seen in Table \ref{table:arpack_toy_timing}, where we construct an artificial matrix and use SciPy's ARPACK interface \cite{scipy_2020} to find the largest and the smallest-magnitude eigenvalues.
